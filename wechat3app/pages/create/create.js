...
Page({
  ...
  onLoad: function (options) {
    com.login(function (userInfo) {
      ...
      com.publishArticle({ "hello": "world", "articleContent": "进入文章界面，就有一个ID号" }, function (res1) {
        console.log("res1, 进入文章界面，就有一个ID号:");
        console.log(res1);
  ...
  updatearticle: function (e) {
    ...
    var zhuanle=e.currentTarget.dataset.zhuanle;
    if (d.content == '') { d.content = zhuanle;}
    zhuanle=3;
    console.log("content:" + d.content + ", articleID:" + articleID + ", zhuanle:" + zhuanle);
    wx.getLocation({
      type: 'wgs84',
      success: function (res) {
        // console.log(res);
        ...
        com.updateArticleContent({ "articleId": articleID, "articleContent": d.content, "latitude": latitude, "longitude": longitude, "zhuanle": zhuanle }, function (res1) {
          console.log("res1, 更新文章内容:");
          console.log(res1);
          if (res1.errmsg != 'ok') {
            wx.showToast({
              title: "内容含有违法违规内容",
